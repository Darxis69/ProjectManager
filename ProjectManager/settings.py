...
SECRET_KEY = 'dzgd^3r)ai_a^(3kpc!5kdi7a9$0y^=v5rz^ng44io!_m0dw_z'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'ProjectManagerApp/templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'ProjectManagerApp.context_processors.authenticated_user_processor',
            ],
        },
    },
]
